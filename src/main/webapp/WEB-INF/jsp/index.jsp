...
<frameset rows="80,*" frameborder="no" border="0" framespacing="0">
    ...
    <frameset rows="*" cols="208,*" framespacing="0" frameborder="no" border="0">
        <frame src="in2.html" name="leftFrame" scrolling="No" noresize="noresize" id="leftFrame" title="leftFrame"/>
        <frame src="in3.html" name="mainFrame" id="mainFrame" title="mainFrame"/>
    </frameset>
</frameset>
<noframes>
    <body>
