package com.gdufe.dbmsapp.config;
...
public class SqlserverGenerator {
     ...
     */
    //生成文件所在项目路径
    private static String baseProjectPath = "D:\\project\\dbmsapp";

    //基础包名
    private static String basePackage="com.gdufe.dbmsapp";
    //设置作者
    private static String authorName="huangshan";
...
//    private static String prefix="t_";
    ...
    public static void main(String[] args) {
        ...
        pc.setParent("com.gdufe.dbmsapp");
        pc.setEntity("entity");
